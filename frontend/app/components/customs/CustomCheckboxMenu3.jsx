							...
							{isCheckboxLoading ? (
								...
								<>
									<div className="w-full flex flex-col p-4 gap-2">
										...
										/>
										<div className="w-full inline-block gap-1 text-[0.75rem] leading-none justify-end">
											<span className="text-[var(--color-secondary)]">
												*
											</span>
											<span>
												Already has reimbursement
												processor
											</span>
										</div>
															...
															(content) => (
																<CustomCheckbox2
																	...
																	label={
																		<>
																			{JSON.parse(
																				content.reimbursement_processor
																			)[0] &&
																			JSON.parse(
																				content.reimbursement_processor
																			)[0] !==
...
export default CustomCheckboxMenu3;
