							...
							{isCheckboxLoading ? (
								...
								<>
									<div className="w-full flex flex-col p-4 gap-2">
										...
										/>
										<div className="w-full flex gap-1 text-[0.75rem] leading-none justify-end">
											<span className="text-[var(--color-secondary)]">
												*
											</span>
											<span>
												Already has final approver
											</span>
										</div>
...
export default CustomCheckboxMenu2;
