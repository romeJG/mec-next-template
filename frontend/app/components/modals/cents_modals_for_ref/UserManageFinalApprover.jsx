...
function UserManageFinalApprover({
	email,
	isModalOpen,
	setIsModalOpen,
	handleConfirm,
	...
	const { getDepartments, setFinalApprover, getUsersByFinalApprovers } =
		useUser();
	...
	const handleAssignFinalApprover = () => {
		setFinalApprover(
			email,
			selectedUsers,
			setIsAssignLoading,
	...
	const handleGetUsersByApprover = () => {
		getUsersByFinalApprovers(email, setSelectedUsers, setIsSelectedLoading);
	};
		...
		<>
			...
			<div className="w-full flex px-6 pt-2 gap-2 border-t border-[var(--color-grey)]">
				<CustomButton
					...
					buttonClick={handleAssignFinalApprover}
	...
	return (
		<>
			<CustomModalNoScroll
				...
				modalSize="sm"
				modalTitle="Manage Final Approver"
...
export default UserManageFinalApprover;
