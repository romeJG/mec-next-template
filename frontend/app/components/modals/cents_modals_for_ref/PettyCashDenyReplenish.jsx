...
function PettyCashDenyReplenish({
	isModalOpen,
	setIsModalOpen,
	...
	const { denyPettyCashReplenishment } = useAudit();
	...
	const handleConfirm = async () => {
		await denyPettyCashReplenishment(
			details.id,
			note,
			setIsLoading,
			setIsError,
...
export default PettyCashDenyReplenish;
