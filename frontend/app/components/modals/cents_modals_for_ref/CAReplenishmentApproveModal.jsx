...
function CAReplenishmentApproveModal({
	isModalOpen,
	setIsModalOpen,
	details,
	getAllRequest,
	...
	const {
		...
		getAttachmentImage,
		returnReplenishedCARecord,
		approveCAReplenishment,
	} = useReplenishment();
	...
	const handleConfirmReturn = async () => {
		...
		await returnReplenishedCARecord(
			details.id,
			userInfo.user_creds.email,
			returnNotes,
			setIsLoadingReturn,
	...
	return (
		<>
			<CustomModalNoScroll
				...
				modalSize="md"
				modalTitle="Review Replenished CA Record"
			...
			<CustomModalNoScroll
				...
				modalSize="md"
				modalTitle="Approve CA Replenishment Record"
				modalTitleTWStyle="leading-none px-6"
			...
			<CustomModalNoScroll
				...
				modalSize="md"
				modalTitle="Return CA Replenishment Record"
				modalTitleTWStyle="leading-none px-6"
...
export default CAReplenishmentApproveModal;
