...
function ReplenishmentPreviewImage({ isModalOpen, setIsModalOpen, imageName }) {
	const { getAttachmentImage } = useReplenishment();
	const { isMobile } = useDeviceSize();
	const [image, setImage] = useState("");
	const [isImageLoading, setIsImageLoading] = useState(false);

	const handleGetImage = async () => {
		await getAttachmentImage(imageName, setImage, setIsImageLoading);
	};
...
export default ReplenishmentPreviewImage;
