...
function CARequestListCancelModal({
	details,
	fullname,
	getAllRequest,
	isModalOpen,
	...
	const { requestorCancelCARequest } = useCashAdvance();
	...
	const handleProceedCancelRequest = async () => {
		...
		await requestorCancelCARequest(
			details.ref_number,
			fullname,
			role,
			note,
	...
	return (
		<>
			...
			<CustomAlertModal
				...
				modalHeadline="Cancel CA Request?"
				modalMessage="Proceeding will cancel the cash advance request."
...
export default CARequestListCancelModal;
