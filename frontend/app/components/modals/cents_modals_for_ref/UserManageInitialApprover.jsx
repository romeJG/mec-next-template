...
import CustomCheckboxMenu from "../customs/CustomCheckboxMenu";
...
function UserManageInitialApprover({
	email,
	isModalOpen,
	setIsModalOpen,
	handleConfirm,
	...
	const { getDepartments, setInitialApprover, getUsersByInitialApprovers } =
		useUser();
	...
	const handleAssignInitialApprover = () => {
		setInitialApprover(
			email,
			selectedUsers,
			setIsAssignLoading,
	...
	const modalContent = (
		<>
			<div className="w-full h-full min-h-[15rem] pt-2 flex flex-col gap-2">
			...
			<div className="w-full flex px-6 pt-2 gap-2 border-t border-[var(--color-grey)]">
				<CustomButton
					...
					buttonClick={handleAssignInitialApprover}
	...
	return (
		<>
			<CustomModalNoScroll
				...
				modalSize="sm"
				modalTitle="Manage Initial Approver"
...
export default UserManageInitialApprover;
