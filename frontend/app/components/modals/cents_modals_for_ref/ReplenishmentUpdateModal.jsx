...
function ReplenishmentUpdateModal({
	isModalOpen,
	setIsModalOpen,
	details,
	...
	const handleUpdateReplenishement = async () => {
		...
		await postUpdateReplenishement(
			details.id,
	...
	return (
		<>
			<CustomModalNoScroll
				...
				modalSize="md"
				modalTitle="Edit Replenished Request"
...
export default ReplenishmentUpdateModal;
